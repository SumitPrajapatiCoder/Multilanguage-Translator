...
# 🔥 GLOBAL CACHE (BETTER: DICT FOR MULTIPLE USERS)
...
def process_stream(text, source_language, target_language, gender="male"):
    ...
    # 🔥 OPTIONAL: LIMIT CACHE SIZE (PREVENT MEMORY ISSUE)
